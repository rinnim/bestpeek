...
export default function ProductViewsBarChart({
  stats,
  title,
  subTitle,
  className,
      ...
      >
        <ResponsiveContainer width="100%" height="100%">
          <BarChart data={filteredData} margin={{ right: 15 }}>
            ...
            <Legend content={<CustomLegend totalViews={totalViews} />} />
            <Bar dataKey="views" fill={color} />
          </BarChart>
        </ResponsiveContainer>
      </div>
    </div>
...
// Custom Legend
const CustomLegend = ({ payload, totalViews }) => {
  return (
